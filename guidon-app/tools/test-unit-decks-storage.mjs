/**
 * Unit decks: backup round trip, damaged rows, Guest and Kiosk save nothing, update keeps progress
 *
 ...
 *
 * Started with tools/new-suite.mjs unit-decks-storage. The house rules it starts you
...
// TODO(unit-decks-storage): the real assertions. The usual shape of one step:
...
bad("TODO: tools/test-unit-decks-storage.mjs was scaffolded by tools/new-suite.mjs and has not been written yet");
