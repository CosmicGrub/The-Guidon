 ...
 * entries of at most 8 names each (the <=8-concurrent-Chromium ceiling the
 ...
 *       every chunk name is in package.json, no chunk exceeds 8 names, and
 ...
 * list in its own order, 8 names per chunk; every other byte of ci.yml is
