 ...
 * radio, fitness standards, LOAC, pay/benefits, history - a large share of
...
export const TOPIC_PILLAR = {
  ...
  "Foundations": DB, "Uniform Standards": DB,
};

export function pillarForBoard(q) { return CATEGORY_PILLAR[q.category] || null; }
export function pillarForDoctrine(e) { return TOPIC_PILLAR[e.topic] || null; }
