...
(function () {
  ...
  function mergeDeck(deck) {
    ...
    var byQ = new Map();
    var ids = new Set();
    bank.forEach(function (q) { byQ.set(norm(q.q), q); ids.add(q.id); });
    var stats = { sourceCards: deck.cards.length, qas: 0, added: 0, matched: 0 };
    deck.cards.forEach(function (card) {
      card.qa.forEach(function (pair, i) {
        ...
        bank.push(rec); byQ.set(k, rec); ids.add(id); stats.added++;
      });
    });
    G.boardSupplement = G.boardSupplement || { decks: [], totals: { sourceCards: 0, qas: 0, added: 0, matched: 0 } };
  ...
  mergeDeck({ id: "core72", cards: [
    ...
    {n:2,title:"Loyalty & Duty",category:"Army Values",source:"ADP 6-22",qa:[["What is Loyalty?","Bear true faith and allegiance to the U.S. Constitution, the Army, your unit, and other Soldiers."],["What is Duty?","Fulfill your obligations and accept responsibility for your actions and those entrusted to you."]]},
    ...
    {n:25,title:"Governing Publications",category:"AR 670-1 — Uniform Standards",source:"AR 670-1 / DA PAM 670-1",qa:[["What regulation governs wear and appearance of Army uniforms and insignia?","AR 670-1."],["What publication provides detailed uniform wear guidance?","DA PAM 670-1."]]},
    ...
    {n:55,title:"H2F",category:"Holistic Health & Fitness",source:"FM 7-22",qa:[["What are the five H2F readiness domains?","Physical, nutritional, mental, spiritual, and sleep readiness."],["What publication covers H2F?","FM 7-22, Holistic Health and Fitness."]]},
    {n:56,title:"Current Fitness Test",category:"Army Fitness Test",source:"Army Directive 2025-06 / Army AFT implementation guidance",qa:[["What is the Army's current physical fitness test of record?","The Army Fitness Test, or AFT, effective June 1, 2025."],["Should you answer ACFT because an older study guide says so?","No. Use current Army policy and your board MOI."]]},
    {n:57,title:"AFT Events",category:"Army Fitness Test",source:"Army Directive 2025-06 / Army AFT implementation guidance",qa:[["What are the five AFT events?","Three-Repetition Maximum Deadlift, Hand-Release Push-Up Arm Extension, Sprint-Drag-Carry, Plank, and Two-Mile Run."],["What happened to the Standing Power Throw in the AFT?","It was removed during the transition from the six-event ACFT to the five-event AFT."]]},
    {n:58,title:"Physical Readiness",category:"Holistic Health & Fitness",source:"FM 7-22",qa:[["What is physical readiness?","The ability to meet the physical demands of duty and combat while reducing preventable injury and sustaining performance."],["Who is responsible for physical readiness?","Individual Soldiers and leaders; commanders and NCOs plan, execute, assess, and enforce readiness standards."]]},
    {n:59,title:"Recovery",category:"Holistic Health & Fitness",source:"FM 7-22",qa:[["Why are sleep and recovery part of readiness?","They support physical recovery, cognitive performance, learning, resilience, and sustained mission performance."],["Is more training always better?","No. Effective programming balances appropriate overload with recovery, progression, and mission requirements."]]},
    {n:60,title:"Nutrition & Mental Readiness",category:"Holistic Health & Fitness",source:"FM 7-22",qa:[["Why is nutrition readiness important?","Fueling and hydration affect health, recovery, body composition, cognition, and performance."],["What is mental readiness?","The ability to use psychological and cognitive skills to meet demands, adapt, make decisions, and sustain performance."]]},
    {n:61,title:"Rifle & Carbine",category:"Weapons — M4/M16",source:"TC 3-22.9",qa:[["What publication covers the rifle and carbine?","TC 3-22.9, Rifle and Carbine."],["What weapon families does TC 3-22.9 address?","The M4- and M16-series weapon systems and their employment."]]},
    {n:62,title:"Weapon Safety",category:"Weapons — M4/M16",source:"TC 3-22.9",qa:[["What is the first rule when handling a weapon?","Treat every weapon as if it is loaded."],["Where should the muzzle point?","Never at anything you do not intend to engage; maintain positive muzzle awareness."]]},
    {n:63,title:"Trigger & Selector",category:"Weapons — M4/M16",source:"TC 3-22.9",qa:[["Where should your trigger finger be until you intend to fire?","Straight and off the trigger, outside the trigger guard."],["When should the weapon be placed on FIRE?","Only when you intend to fire in accordance with the situation and commands."]]},
    {n:64,title:"Shot Process",category:"Weapons — M4/M16",source:"TC 3-22.9",qa:[["What is the shot process?","The Soldier's systematic application of firing tasks and fundamentals to detect, identify, engage, and assess targets."],["Why is consistency important in the shot process?","Consistent position, aiming, trigger control, and follow-through improve accuracy and repeatability."]]},
    {n:65,title:"Malfunctions",category:"Weapons — M4/M16",source:"TC 3-22.9",qa:[["What should you do if the weapon fails to fire?","Maintain muzzle awareness and apply the trained immediate or remedial action appropriate to the weapon and malfunction."],["Should you improvise a clearing procedure you do not remember?","No. Follow trained procedures, range commands, and applicable publications."]]},
    {n:66,title:"Maintenance",category:"Weapons — M4/M16",source:"TC 3-22.9 / applicable technical manual",qa:[["Why is preventive maintenance important for a weapon?","It supports safe operation, reliability, serviceability, and combat readiness."],["What should a Soldier do before and after firing?","Inspect and maintain the weapon as required, identify faults, and follow the applicable technical manual, range SOP, and unit procedures."]]},
    {n:67,title:"Current Publication",category:"Land Navigation",source:"TC 3-25.26",qa:[["What current publication covers Map Reading and Land Navigation?","TC 3-25.26."],["Why might an older study guide say FM 3-25.26?","FM 3-25.26 was the older designation; current Army training references use TC 3-25.26."]]},
    {n:68,title:"Marginal Information",category:"Land Navigation",source:"TC 3-25.26",qa:[["Why is marginal information important?","It provides map identification, scale, contour interval, grid information, declination data, and other information needed to use the map correctly."],["What should you check before navigating?","Correct map sheet and edition, scale, grid zone, contour interval, declination information, and area of operation."]]},
    {n:69,title:"Grid Coordinates",category:"Land Navigation",source:"TC 3-25.26",qa:[["What is the purpose of a grid coordinate?","To identify a location on a military map using the grid reference system."],["What memory aid helps when plotting grid coordinates?","Read right, then up."]]},
    {n:70,title:"Azimuth",category:"Land Navigation",source:"TC 3-25.26",qa:[["What is an azimuth?","A horizontal angle measured clockwise from a reference direction, commonly north, to a line of direction."],["How many degrees are in a circle?","360 degrees."]]},
    {n:71,title:"Terrain Features",category:"Land Navigation",source:"TC 3-25.26",qa:[["What are the five major terrain features?","Hill, ridge, valley, saddle, and depression."],["Name three commonly taught minor terrain features.","Draw, spur, and cliff."]]},
    {n:72,title:"Compass & Pace Count",category:"Land Navigation",source:"TC 3-25.26",qa:[["What is pace count used for?","Estimating distance traveled on the ground."],["Why must you account for declination when required?","Grid north and magnetic north differ. Correct conversion prevents directional error when moving between a map and compass."]]}
  ]});
})();
