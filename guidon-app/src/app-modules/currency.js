...
(function () {
  ...
  async function render(mount) {
    ...
    sorted.forEach(function (d) {
      ...
      const head = el("div", { style: "display:flex;justify-content:space-between;gap:8px;flex-wrap:wrap;align-items:baseline" });
      head.appendChild(el("span.k", { text: d.area }));
      head.appendChild(el("span.v", { text: age ? (age.months < 1 ? "this month" : age.months + " months old") : "—" }));
      p.appendChild(head);
