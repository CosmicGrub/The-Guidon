...
(function () {
  ...
  add({
    ...
    doctrine: [{ pub: "AR 710-2", para: "4-26 (overdue deliveries) and 4-22 (requests and requisitions)", edition: "2024-07", quoteKind: "paraphrase" }],
    defaultMode: "cyoa",
  ...
  add({
    ...
    estMinutes: 3,
    difficulty: "Intermediate",
    doctrine: [{ pub: "AR 710-2", para: "6-5 (physical inventory and location survey) and 6-6 (discrepancies, causative research, adjustments)", edition: "2024-07", quoteKind: "paraphrase" }, { pub: "AR 735-5", para: "inventory adjustment reports and relief from responsibility", edition: "2026-04", quoteKind: "paraphrase" }],
    defaultMode: "cyoa",
    renderModes: ["text", "course", "cyoa"],
