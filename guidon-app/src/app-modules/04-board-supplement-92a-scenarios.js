...
(function () {
  ...
  add({
    ...
    doctrine: [{ ref: "GCSS-Army / Army supply procedures", para: "Order status and exception management", asOf: "2026-09" }],
    defaultMode: "cyoa",
  ...
  add({
    ...
    estMinutes: 3,
    difficulty: "Intermediate",
    doctrine: [{ ref: "AR 710-4 / GCSS-Army procedures", para: "Inventory discrepancy research and authorized adjustment", asOf: "2026-09" }],
    defaultMode: "cyoa",
    renderModes: ["text", "course", "cyoa"],
