...
|---|---|---|
| **Windows (PC)** | [`releases/v1.4.7/GUIDON_1.4.7_x64-setup.exe`](releases/v1.4.7/) — per-user installer, no admin. MSI alongside for managed deployment. | [`guidon-app/src-tauri/`](guidon-app/src-tauri/) (Tauri 2, ~2.4 MB) |
| **Android** | [`releases/v1.4.7/GUIDON-1.4.7-release.apk`](releases/v1.4.7/) — signed, sideloadable. AAB alongside for a future Play listing. | [`guidon-app/android/`](guidon-app/android/) (Capacitor 8) |
...
| **Single file** | [`releases/v1.4.7/GUIDON-1.4.7-standalone.html`](releases/v1.4.7/) — open from disk, no server, no network, no install. | same source, build variant |
...
lands everywhere on the next build. Checksums: [`releases/v1.4.7/SHA256SUMS.txt`](releases/v1.4.7/SHA256SUMS.txt).
