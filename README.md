...
|---|---|---|
| **Windows (PC)** | [`releases/v1.4.4/GUIDON_1.4.4_x64-setup.exe`](releases/v1.4.4/) — per-user installer, no admin. MSI alongside for managed deployment. | [`guidon-app/src-tauri/`](guidon-app/src-tauri/) (Tauri 2, ~2.4 MB) |
| **Android** | [`releases/v1.4.4/GUIDON-1.4.4-release.apk`](releases/v1.4.4/) — signed, sideloadable. AAB alongside for a future Play listing. | [`guidon-app/android/`](guidon-app/android/) (Capacitor 8) |
...
| **Single file** | [`releases/v1.4.4/GUIDON-1.4.4-standalone.html`](releases/v1.4.4/) — open from disk, no server, no network, no install. | same source, build variant |
...
lands everywhere on the next build. Checksums: [`releases/v1.4.4/SHA256SUMS.txt`](releases/v1.4.4/SHA256SUMS.txt).
...
v1.4.4 · verified by sixteen automated suites (build, promotion-point tables vs
